...
/** Vector table entry type: function pointer */
typedef void (*const vector_func_t)(void);

/**
 * @brief  Interrupt vector table.
 *         Placed in .reset_vector_table section at the beginning of flash.
 */
__attribute__((section(".reset_vector_table"), used))
const vector_func_t vector_table[] = {
        (vector_func_t)_msp_top, /*     Top of Stack */
